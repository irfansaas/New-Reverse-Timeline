...
function createExecutiveSummarySheet(calculations) {
  ...
  const data = [
    ...
    [''],
    ['ROI METRICS'],
    ['Payback Period (months):', roiAnalysis.investment.paybackPeriod.months.toFixed(1)],
    ['Year 1 ROI:', roiAnalysis.roi.year1.toFixed(1) + '%'],
    ['Year 2 ROI:', roiAnalysis.roi.year2.toFixed(1) + '%'],
    ['Year 3 ROI:', roiAnalysis.roi.year3.toFixed(1) + '%'],
...
function createROISheet(calculations) {
  ...
  const data = [
    ...
    ['Payback Period:', roiAnalysis.investment.paybackPeriod.months.toFixed(1) + ' months'],
    [''],
    ['ROI BY YEAR'],
    ['Year 1:', roiAnalysis.roi.year1.toFixed(1) + '%'],
    ['Year 2:', roiAnalysis.roi.year2.toFixed(1) + '%'],
    ['Year 3:', roiAnalysis.roi.year3.toFixed(1) + '%'],
    [''],
